...
@Entity
@Table(name="imgresult")
public class ImageResult implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2481013277162251271L;
	...
	public ImageResult(String imgId, String tid, String imgName, String imgUrl, String qulity, int glaucomaRisk, int drRisk, int pmRisk, int amdRisk,
	...
	public String toString() {
		return "ImageResult [imgId=" + imgId + ", qulity=" + qulity + ", glaucomaRisk=" + glaucomaRisk + ", drRisk="
				+ drRisk + ", pmRisk=" + pmRisk + ", amdRisk=" + amdRisk + ", cdr=" + cdr + ", od=" + od + ", oc=" + oc
				+ ", fullPath=" + fullPath + ", cupPath=" + cupPath + ", saveDate=" + saveDate + "]";
	}
